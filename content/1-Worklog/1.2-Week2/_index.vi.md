...
| 6 | - Tìm hiểu AWS KMS và vai trò của khóa mã hóa trong việc bảo vệ dữ liệu trên AWS<br>- Phân biệt AWS Managed Key và Customer Managed Key; tìm hiểu cách các dịch vụ như S3 và DynamoDB sử dụng KMS để mã hóa dữ liệu<br>- Tìm hiểu Amazon Cognito User Pool và quy trình đăng ký, xác nhận email, đăng nhập, nhận token và đăng xuất<br>- Ghi chú yêu cầu sử dụng HTTPS cho OAuth callback | 03/07/2026 | 03/07/2026 | [AWS KMS](https://docs.aws.amazon.com/kms/), [Amazon Cognito](https://docs.aws.amazon.com/cognito/) |
| 7 | - Ôn lại kiến thức về S3, CloudFront, RDS, Aurora, DynamoDB, Auto Scaling, KMS và Cognito<br>- Trao đổi với nhóm về lựa chọn kiến trúc Serverless nhằm giảm công việc vận hành và tối ưu chi phí trong giai đoạn thực tập<br>- Xác định phần việc xử lý tài liệu: nhận tệp từ S3, xử lý bằng Lambda và Textract, sau đó chuẩn hóa nội dung cho hệ thống RAG<br>- Hoàn thiện Worklog và tổng hợp các vấn đề cần tiếp tục nghiên cứu trong tuần sau | 04/07/2026 | 04/07/2026 | [AWS Architecture Center](https://aws.amazon.com/architecture/), [AWS Serverless](https://aws.amazon.com/serverless/) |
